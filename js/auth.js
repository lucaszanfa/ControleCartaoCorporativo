...
function aplicarMenuPrincipal() {
  ...
  sidebar.innerHTML = `
    <div class="sidebar-brand"><img class="sidebar-logo" src="img/images-removebg-preview.png" alt="SM&A"><div><strong>Cartões Corporativos</strong><small>Controle e conciliação</small></div><button class="sidebar-menu-button" type="button" aria-label="Menu lateral">${svgIcone("menu", "icon-sm")}</button></div>
